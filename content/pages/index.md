...
sections:
  ...
  howItWorks:
    ...
    steps:
      - title: Book the $1,500 Task
        description: Fixed price, fixed scope. No surprises.
  ...
  affiliate:
    ...
    intro: Earn by sharing Tradealink through Whop.
    perks:
      - "Earn 20–40% per referral"
      - Perfect for students, creators, freelancers
      - Custom links & dashboard provided
      - Promote the tools directory or task portal
      - No approval needed
  faq:
    title: FAQ
    items:
      ...
      - label: Do I need an account?
        content: "No — Whop creates secure access for you automatically."
      - label: Is this automated?
        content: "We build by hand with Nuxt + Nuxt UI; some content wiring and QA are assisted."
---

Welcome to Tradealink. The content above powers the landing page hero, sections, pricing, and FAQs.
